...
var require_breakpoints = __commonJS({
  "node_modules/@material-tailwind/react/theme/base/breakpoints.js"(exports, module) {
    "use strict";
    var breakpoints = { sm: "540px", md: "720px", lg: "960px", "lg-max": { max: "960px" }, xl: "1140px", "2xl": "1320px" };
    module.exports = breakpoints;
  }
});

// node_modules/@material-tailwind/react/utils/withMT.js
var require_withMT = __commonJS({
  "node_modules/@material-tailwind/react/utils/withMT.js"(exports, module) {
    ...
    var shadows = require_shadows();
    var breakpoints = require_breakpoints();
    var materialTailwindConfig = { darkMode: "class", content: ["./node_modules/@material-tailwind/react/components/**/*.{js,ts,jsx,tsx}", "./node_modules/@material-tailwind/react/theme/components/**/*.{js,ts,jsx,tsx}"], theme: { colors, fontFamily: typography, boxShadow: shadows, screens: breakpoints }, plugins: [] };
    function withMT(tailwindConfig) {
      var themeFont = materialTailwindConfig.theme.fontFamily;
      if (tailwindConfig.theme.fontFamily) {
        var _tailwindConfig_theme_fontFamily = tailwindConfig.theme.fontFamily, sans = _tailwindConfig_theme_fontFamily.sans, serif = _tailwindConfig_theme_fontFamily.serif, body = _tailwindConfig_theme_fontFamily.body;
        themeFont.sans = sans || themeFont.sans;
        themeFont.serif = serif || themeFont.serif;
        themeFont.body = body || themeFont.body;
      }
      return merge(materialTailwindConfig, _objectSpread({}, tailwindConfig));
    }
    module.exports = withMT;
  }
});
export default require_withMT();
//# sourceMappingURL=@material-tailwind_react_utils_withMT.js.map
